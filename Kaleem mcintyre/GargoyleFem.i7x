Version 1 of GargoyleFem by Kaleem mcintyre begins here.
...
When Play begins:
	...
	add "Gargoyle" to infections of FemaleList;
	...
	now Breast Size entry is 15; [Size of breasts infection will try to attain ]
	now Male Breast Size entry is 0; [ Breast size for if Sex="Male", usually zero. ]
	now Cunt Count entry is 1; [ if sex = "Female or both", indicates the number of female sexes infection will grant you.]
	now Cunt Depth entry is 20; [penetratable length in inches; some minor stretching allowed, or more with Twisted Capacity]
	now Cunt Tightness entry is 24; [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
...
"GargoyleFem Infection"	"Infection"	""	Gargoylegem Infection rule	1000	false

This is the Gargoyle Infection rule:
	if Player has a body of "GargoyleFem":
		trigger ending "GargoyleFem Infection";
		if humanity of Player < 10:
			if Player is male:
				say "     Having been infected by the strain of female gargoyle mutation, you find that day by day your weeping cock is shrinking itself down inch by inch. Not understanding this at first, you panic and roar to the sky as you fly over the country without thought or destination. Soon though your mournful cries are lost to you, the same as your cock, as your cock disapears and then seals tight leaving nothing but a fine, smooth skinned line behind for you to remember it by. Moaning and grunting as your mind tries to understand what's going on you are soon given your answers when another gargoyle finds her way over to you and then moves to claim you as a mate. On your knees under the impressive female you find that any masculine traits you may have had slowly change over to feminine ones as your body hardens further into becoming a perfect gargoyle. In the dim part of your foggy brain that can recall much of what it means to be human you come to realize that gargoyle must be inherently female and that any male coming into sexual contact with them will slowly lose their masculinity until they fully become female. This means little to you though as when your mate finishes seeding you, for you are already forgetting you ever were partially male.";
			else:
